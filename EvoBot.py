...
async def on_member_join(member):
    if member.server.id == "474988884426752013":
        ...
        await client.send_message(channel, f"<:check:475814904272781315> Welcome {member.mention} To **Evolutionary**! Our goal is to support people new to coding languages & help them with whatever they need!")
